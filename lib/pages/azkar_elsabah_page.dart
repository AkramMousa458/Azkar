...
class AzkarElsabahPage extends StatelessWidget {
  const AzkarElsabahPage({super.key});
          ...
          child: ListView(
            children: [
              ...
              Zkr(
                  title: '',
                  body:
                      'اللّهُـمَّ عافِـني في بَدَنـي ، اللّهُـمَّ عافِـني في سَمْـعي ، اللّهُـمَّ عافِـني في بَصَـري ، لا إلهَ إلاّ أَنْـتََ.',
                  number: 3),
              Zkr(
                  title: '',
                  body:
                  'اللّهُـمَّ إِنّـي أَعـوذ ُبِكَ مِنَ الْكُـفر ، وَالفَـقْر ، وَأَعـوذ ُبِكَ مِنْ عَذابِ القَـبْر ، لا إلهَ إلاّ أَنْـتَ.',
                  number: 3),
              Zkr(
                  title: '',
                  body:
              ...
              Zkr(
                  title: '',
                  body:
                      'لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَىْءٍ قَدِيرًٌ.',
                  number: 10),
              Zkr(
                  title: '',
                  body:
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    setZkr(name: 'azkarElsabah', num: azkarElsabah == null ? 1 : azkarElsabah += 1);
                  },
                  child: Container(
